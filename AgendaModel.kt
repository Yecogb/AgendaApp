...
class AgendaModel {
    ...
    private val api: AgendaApi = RetrofitInstance.api

    fun saveAgendaItem(agendaItem: AgendaItem, context: Context, onSuccess: () -> Unit, onError: () -> Unit) {
        val call = api.addAgenda(agendaItem)
    ...
    fun fetchAgendaItems(context: Context, onSuccess: (List<AgendaItem>) -> Unit, onError: () -> Unit) {
        val call = api.getAgenda()
